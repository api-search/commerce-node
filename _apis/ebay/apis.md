...
apis:
  ...
  - name: Client Registration API
    ...
    properties:
      ...
      - type: Release Notes        
        url: https://developer.ebay.com/api-docs/commerce/client-registration/release-notes.html
  ...
  - name: Key Management API
    ...
    properties:
      ...
      - type: Release Notes        
        url: https://developer.ebay.com/api-docs/commerce/key-management/release-notes.html
